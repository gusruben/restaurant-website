...
<div class="screen-section h-auto py-28">
	<div class="max-w-3xl" id="terms-of-service">
		...
		<ul>
			...
			<li>
				<p>
					...
					in this Agreement) refers to Azur LLC, 1600 Pennsylvania Avenue.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Azur, accessible from
					<a href="https://azur.restaurant" rel="external nofollow noopener" target="_blank">https://azur.restaurant</a>
				</p>
			</li>
			<li>
				<p>
		...
		<ul>
			<li>By email: support@azur.restaurant</li>
		</ul>
	</div>
	<div class="max-w-3xl mt-16" id="privacy-policy">
		<h1>Privacy Policy</h1>
		<p>
			Azur operates the website "Azur Restaurant" at https://azur.restaurant. We take your privacy seriously. To better
			protect your privacy, we provide this privacy policy notice explaining the way your personal information is
			collected and used.
		</p>
		<p><strong>Collection of Routine Information</strong></p>
		<p>
			This website track basic information about its visitors. This information includes, but is not limited to, IP
			addresses, browser details, timestamps and referring pages. None of this information can personally identify
			specific visitors to this website. The information is tracked for routine administration and maintenance purposes.
		</p>
		<p><strong>Cookies</strong></p>
		<p>
			Where necessary, this website uses cookies to store information about a visitor’s preferences and history to
		...
		<p>
			...
			activities on this website to display advertisements and other useful information. Such tracking is done directly
			by the third parties through their servers and is subject to their privacy policies. This website has no access or
		...
		<p>
			This Privacy Policy is effective as of 2025-02-27 and will remain in effect except concerning any changes in its
			provisions in the future, which will be in effect immediately after being posted on this page. We reserve the
			right to update or change our Privacy Policy at any time and you should check this Privacy Policy periodically. If
			we make any material changes to this Privacy Policy, we will notify you either through the email address you have
			provided us or by placing a prominent notice on our website.
		</p>
		<p><strong>Contact Information</strong></p>
		<p>
			For any questions or concerns regarding the privacy policy, please send us an email at <a
				href="mailto:support@azur.restaurant">support@azur.restaurant</a
			>.
		</p>
		<p>Our Address: 1600 Pennsylvania Avenue</p>
	</div>
</div>
